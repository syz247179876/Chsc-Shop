...
from seller_app.apis.seller_commodity_api import ManageCommodityApiView, SkuPropApiView
from seller_app.apis.seller_store_api import SellerStoreApiView

app_name = 'seller_app'

urlpatterns = [
    path(f'{settings.URL_PREFIX}/commodity/',ManageCommodityApiView.as_view() ),
